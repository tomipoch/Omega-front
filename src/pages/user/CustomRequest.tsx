...
import { getServices } from '../../services/appointmentsService';
import { createCustomRequest } from '../../services/customRequestsService';
  ...
  const submitMutation = useMutation({
    mutationFn: async (form: FormData) =>
      createCustomRequest({
        ...
        servicio_id: Number(form.get('servicio_id')),
        detalles: String(form.get('detalles') ?? ''),
      }),
    onSuccess: () => {
    ...
    onError: () => setMensaje('Error al enviar la solicitud.'),
  });
